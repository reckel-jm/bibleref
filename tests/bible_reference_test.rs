...
fn test_bible_reference_representation_try_upcast() {
    ...
    if let BibleReferenceRepresentation::Single(BibleReference::BibleChapter(chapter_ref)) =
        upcasted
    {
...
fn test_bible_book_properties() {
    ...
    assert_eq!(
        bibleref::bible::get_bible_book_by_number(1),
        Some(BibleBook::Genesis)
    );
    assert_eq!(
        bibleref::bible::get_bible_book_by_number(40),
        Some(BibleBook::Matthew)
    );
    assert_eq!(
        bibleref::bible::get_bible_book_by_number(66),
