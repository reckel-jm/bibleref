use bibleref::{
    ...
    parse, translate,
    referencing::language::{get_reference_in_language, BookReferenceType},
};
...
fn test_translate_to_invalid_language() {
    ...
    let valid_references = vec![
        "Genesis 1:1", "Exodus 2:2", "Matthew 5:3", "John 3:16", "Revelation 22:21",
    ];
